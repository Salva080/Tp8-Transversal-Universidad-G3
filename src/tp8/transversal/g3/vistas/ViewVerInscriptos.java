...
public class ViewVerInscriptos extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jbActualizar.setText("Eliminar Inscripcion");
    ...
    private void jbActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbActualizarActionPerformed
        ...
        cd.borrarCursadaDeUnaMateria(alumnoJList.get(index).getId_alumno(),ma.getIdMateria());
        this.cbMateriasActionPerformed(evt);
    ...
    if(cbMaterias.getSelectedItem()!=null){
        ...
        jtEstado.setText("activa");this.obtenerAlumnosNotas(ma);
    }else {jtNombre.setText("");jtAnio.setText("");jtEstado.setText("");}
        // TODO add your handling code here:
    ...
    private void obtenerAlumnosNotas(Materia m){ 
        ...
        for (Cursada c : cd.obtenerCursadas()){                
            ...
            for (Cursada c : cd.obtenerCursadas()){  
                if (m.getIdMateria() == c.getMateria().getIdMateria() && c.getAlumno().isEstado()){
                    String []row = new String[4];
                    row[0] = c.getAlumno().getLegajo()+"";
                    row[1] = c.getAlumno().getNombre();
                    row[2]= "Activo";
